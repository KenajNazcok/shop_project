...
from .models import Customer, Order, OrderItem, Payment, Product, Cart, CartItem
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                return redirect('product_list')  # Po udanym logowaniu przekierowujemy do listy produktów
            else:
            ...
            for product, quantity in request.POST.items():
                ...
                if product.isdigit():
                    ...
                    if isinstance(quantity, int):
                        ...
                        return HttpResponse("Invalid input for product quantity.", status=400)
